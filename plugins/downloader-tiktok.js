...
conn.sendMessage(m.chat, { video: { url: data[data.length - 1] }, caption: '_𝐒𝐡𝐚𝐫𝐤-𝐁𝐨𝐭ㅤ🦈_', footer: await shortUrl(data[data.length - 1]), buttons }, { quoted: m })}
