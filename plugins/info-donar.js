...
let str = `
🦈 Hola!! Que Viva One Piece 💯 Mis Estimados Compañeros, no acepto donaciones es pura joda mia jajaja 👻!`.trim()
  
await conn.sendHydrated(m.chat, str, wm, media, 'No Acepto Donaciones ☠️', '🎁 𝘿𝙤𝙣𝙖𝙧', null, null, [
